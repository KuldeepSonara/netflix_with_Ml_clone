  ...
  return (
    <div className='into'>
            <div className="overlay">
                <a href="#" class="signin" onMouseOver={handleHover} onClick={handleSignInClick}>Sign In</a>
                <form class="signinform">
                    ...
                    <div class="fadeIn">
                        ...
                        <a href="https://www.twitter.com/mixchex" class="link-register">No password</a>
            ...
            <div class="video-wrapper">
                <div class="ResponsiveYTPlayer">
                    <iframe id="video" src="https://www.youtube.com/embed/cSqi-8kAMmM?autoplay=1&playlist=cSqi-8kAMmM&enablejsapi=1&controls=0&disablekb=1&loop=1&mute=1&start=2&end=12" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
                </div>
            </div>
        </div>
  );
